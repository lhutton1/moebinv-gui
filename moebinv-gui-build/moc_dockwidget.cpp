...
QT_MOC_LITERAL(1, 11, 12), // "recenterView"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 31) // "calculateDockToWindowPercentage"

    },
    "dockWidget\0recenterView\0\0"
    "calculateDockToWindowPercentage"
};
...
void dockWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recenterView(); break;
        case 1: _t->calculateDockToWindowPercentage(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dockWidget::recenterView)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (dockWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dockWidget::calculateDockToWindowPercentage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void dockWidget::recenterView()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void dockWidget::calculateDockToWindowPercentage()
{
